...
class RemoteConfigService {
  ...
  Future<void> initialize() async {
    try {
      ...
      await _remoteConfig.setDefaults({
        ...
        // Interstitial (added missing defaults)
        ...
        'open_app_ad_unit_id_production':
            'ca-app-pub-7772180367051787/9876543210',
        'open_app_ad_unit_id_test': 'ca-app-pub-3940256099942544/3419835294',
        'open_app_ad_cache_duration_minutes': 4,
      });
  ...
  int get openAppAdCacheDurationMinutes =>
      _remoteConfig.getInt('open_app_ad_cache_duration_minutes');
}
